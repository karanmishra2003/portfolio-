...
const Education = () => {
  ...
  return (
    <section id="education" className="py-24 px-4 relative overflow-hidden">
      ...
      />
      <div className="absolute top-0 left-1/4 w-72 h-72 bg-purple-600/20 rounded-full blur-3xl animate-pulse" />
      ...
      >
            ...
            <div className="space-y-6">
              {education.map((edu, index) => (
                <motion.div
                  ...
                  whileTap={{ scale: 0.98 }}
                  className="bg-gray-900/80 backdrop-blur-lg rounded-2xl p-6 border border-gray-800 hover:border-purple-500/50 transition-all duration-300 cursor-pointer"
                >
                  <motion.h4 
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {certifications.map((cert, index) => (
                <motion.div
                  ...
                  whileTap={{ scale: 0.98 }}
                  className="bg-gray-900/80 backdrop-blur-lg rounded-xl p-4 border border-gray-800 hover:border-blue-500/50 transition-all duration-300 cursor-pointer"
                >
                  <motion.div 
        ...
        <motion.div variants={itemVariants} className="mt-16">
          <motion.div
            ...
            className="mb-8 bg-gradient-to-r from-purple-600/20 via-pink-600/20 to-cyan-600/20 border border-purple-500/30 rounded-2xl p-6 text-center cursor-pointer"
          >
            <motion.div
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {achievements.map((achievement, index) => (
              <motion.div
                ...
                whileTap={{ scale: 0.98 }}
                className="bg-gray-900/80 backdrop-blur-lg rounded-xl p-5 border border-gray-800 hover:border-pink-500/50 transition-all duration-300 cursor-pointer"
              >
                <motion.div 
